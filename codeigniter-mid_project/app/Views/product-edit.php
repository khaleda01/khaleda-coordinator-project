  ...
  <div class="container mt-5">
    ...
    action="<?= site_url('/updatep') ?>">
      ...
      <div class="form-group">
        ...
        <input type="text" name="category" class="form-control" value="<?= $user_obj['category']?>">
      </div>
      <div class="form-group">
        <label>Unit</label>
        <input type="text" name="unit" class="form-control" value="<?= $user_obj['unit']?>">
      </div>
      <div class="form-group">
        <label>Brand</label>
        <input type="text" name="brand" class="form-control" value="<?= $user_obj['brand']?>">
      </div>
      <div class="form-group">
        <label>Price</label>
