...
<div class="container-fluid">
  ...
  <div class="container mt-5">
    ...
    <form method="post" id="add_create" name="add_create" 
    action="<?= site_url('submit-cform') ?>">
                        <div class="form-group">
                          <label for="">Category Name:</label>
                          <input class="form-control" type="text" name="name" class="form-control" type="text" placeholder="Enter category Name">
                        </div>
                        <br>
                        <!-- <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" name="unit" class="form-control" placeholder="Enter product unit">
                        </div>
                        <br> -->
